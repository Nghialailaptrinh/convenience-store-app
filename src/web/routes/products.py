...
from application.products.get_product_by_id import query as get_product_slice
from application.products.get_products import query as get_products_slice
